...
fn run_program(initial_memory: &HashMap<i64, i64>) -> Vec<Vec<TileType>> {
        ...
        match op {
            ...
            4 => {
                ...
                match next_char {
                    ...
                    '.' => {
                        current_row.push(Space);
                    }
                    '\n' => {
                        if current_row.len() > 0 {
                            result_map.push(current_row);
                        }
                        current_row = Vec::new();
                    }
                    '^' => {
                        current_row.push(Robot(Up));
                    }
                    'v' => {
                        current_row.push(Robot(Down));
                    }
                    '<' => {
                        current_row.push(Robot(Left));
                    }
                    '>' => {
                        current_row.push(Robot(Right));
                    }
                    _ => {
                        panic!("Unknown character {}", next_char);
                    }
                }
                i += 2;
            }
