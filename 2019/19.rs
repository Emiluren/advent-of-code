...
fn main() {
    ...
    // for y in 0..100 {
    //     for x in 0..100 {
    //         if run_program(&input_map, [start_x + x, start_y + y].iter().cloned()) {
    //             print!("#");
    //         } else {
    //             print!(".")
    //         }
    ...
    loop {
        ...
        for x in 0..100 {
            if !run_program(&input_map, [start_x + x, start_y].iter().cloned()) {
                if x == 0 {
                    panic!("something's wrong, x out of bounds ({}, {})", start_x, start_y);
                }
                fail_x = x;
                break;
            }
        ...
        for y in 0..100 {
            if !run_program(&input_map, [start_x, start_y + y].iter().cloned()) {
                if y == 0 {
                    panic!("something's wrong, y out of bounds ({}, {})", start_x, start_y);
                }
                fail_y = y;
                break;
            }
    ...
    println!("Part 2: {}", start_x * 10_000 + start_y);
}
